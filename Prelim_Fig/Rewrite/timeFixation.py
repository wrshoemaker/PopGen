...
plt.plot(p, line2, color = 'b',linestyle = '--', label="N = 1000, B = 10")
plt.plot(p, line3, color = 'b',linestyle = '-.', label="N = 1000, B = 100")
plt.plot(p, line4, color = 'b',linestyle = ':', label="N = 1000, B = 1,000")
