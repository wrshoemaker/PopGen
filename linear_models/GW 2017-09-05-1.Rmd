...
1. Generate 1000 samples from a Chi-squared distribution with 1 degree of freedom sand save to a variable called `y_1df`.  Compute the mean and variance of `y_1df` and compare these with the theoretical values.  Plot overlaid histograms of `x1_sq` and `y_1df`, using transparency and two different colors as above.  Use the same number of breaks for both histograms.  Compare the two distributions.
...
2. Generate 1000 samples from a Chi-squared distribution with 2 degrees of freedom sand save to a variable called `y_2df`.  Compute the mean and variance of `y_2df` and compare these with the theoretical values.  Plot overlaid histograms of `x1_x2_sq` and `y_2df`, using transparency and two different colors as above.  Use the same number of breaks for both histograms.  Compare the two distributions.
